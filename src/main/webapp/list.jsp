...
<<<<<<< HEAD
						<td style="width: 10.00%" scope="row"><a href="${linkDelete}" onclick="return confirm('Want to delete?');">delete</a></td>
=======
						<td style="width: 10.00%" scope="row"><a href="${linkDelete}"
							onclick="return confirm('Want to delete this password?');">delete</a></td>
>>>>>>> branch 'master' of https://github.com/DianaGJ/Capstone-Project.git
					</tr>
